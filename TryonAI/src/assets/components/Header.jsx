...
// Header component has a background image and a call-to-action button
const Header = ({ scrollToClothesSelector }) => (
  <header>
    {/*Includes Navbar component and passes the scrollToClothesSelector function as a prop */}
    ...
    >
      <div>
        ...
        <button
          ...
          onClick={scrollToClothesSelector}  // Triggers scrollToClothesSelector when clicked
        >
          Select Clothes
        </button>
      </div>
